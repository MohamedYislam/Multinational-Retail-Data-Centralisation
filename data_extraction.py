...
class DataExtractor:
    ...
    # Task 3 step 5
    def read_rds_table(self, db_connector, table_name = 'legacy_users'):  # Define a method to extract a table from the database into a DataFrame (Task 3, Step 5)
        """
        ...
        """
        engine = db_connector.init_db_engine()  # Initialize the database engine using the provided DatabaseConnector instance
